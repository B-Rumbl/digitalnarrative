...
function textreveal() {
    ...
    document.getElementById("orbrip000").style.animationDelay = "0s";
}
...
function textrevealtwo() {
    ...
    document.getElementById("orbrip001").style.animationDelay = "0s"
}
...
function textrevealthree() {
    ...
    document.getElementById("orbrip002").style.animationDelay = "0s"
}
...
function textrevealfour() {
    ...
    document.getElementById("orbrip000a").style.animationDelay = "0s"
}
...
function textrevealfive() {
    ...
    document.getElementById("orbrip001a").style.animationDelay = "0s"
}
...
function textrevealsix() {
    ...
    document.getElementById("orbrip002a").style.animationDelay = "0s"
}
...
function textreveal7() {
    ...
    document.getElementById("orbrip003").style.animationDelay = "0s"
}
...
function textreveal8() {
    ...
    document.getElementById("orbrip004").style.animationDelay = "0s"
}
...
function textrevealnine() {
    ...
    document.getElementById("orbrip005").style.animationDelay = "0s"
}
...
function textrevealten() {
    ...
    document.getElementById("orbrip003a").style.animationDelay = "0s"
}
...
function textrevealeleven() {
    ...
    document.getElementById("orbrip004a").style.animationDelay = "0s"
}
...
function textrevealtwelve() {
    ...
    document.getElementById("orbrip005a").style.animationDelay = "0s";
